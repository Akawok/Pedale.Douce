...
$i=1;
$Query_Check_terminalID = "SELECT terminal_id FROM terminals WHERE station_id = '2'";
...
$i=1;
$Query_Check_Avail = "SELECT availability_id FROM terminals WHERE station_id = '2'";
...
$Query_Check_Bike = "SELECT serial_nb,terminal_id FROM bikes WHERE terminal_id = '11' OR terminal_id = '12' OR terminal_id = '13' OR terminal_id = '14' OR terminal_id = '15' OR terminal_id = '16' OR terminal_id = '17' OR terminal_id = '18' OR terminal_id = '19' OR terminal_id = '20'";//STATE NULL
