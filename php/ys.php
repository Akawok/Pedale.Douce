...
$i=1;
$Query_Check_terminalID = "SELECT terminal_id FROM terminals WHERE station_id = '4'";
...
$i=1;
$Query_Check_Avail = "SELECT availability_id FROM terminals WHERE station_id = '4'";
...
$Query_Check_Bike = "SELECT serial_nb,terminal_id FROM bikes WHERE terminal_id = '31' OR terminal_id = '32' OR terminal_id = '33' OR terminal_id = '34' OR terminal_id = '35' OR terminal_id = '36' OR terminal_id = '37' OR terminal_id = '38' OR terminal_id = '39' OR terminal_id = '40'";//STATE NULL
