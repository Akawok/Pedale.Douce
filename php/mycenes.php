...
$i=1;
$Query_Check_terminalID = "SELECT terminal_id FROM terminals WHERE station_id = '7'";
...
$i=1;
$Query_Check_Avail = "SELECT availability_id FROM terminals WHERE station_id = '7'";
...
$Query_Check_Bike = "SELECT serial_nb,terminal_id FROM bikes WHERE terminal_id = '61' OR terminal_id = '62' OR terminal_id = '63' OR terminal_id = '64' OR terminal_id = '65' OR terminal_id = '66' OR terminal_id = '67' OR terminal_id = '68' OR terminal_id = '69' OR terminal_id = '70'";//STATE NULL
