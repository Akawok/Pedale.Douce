...
$i=1;
$Query_Check_terminalID = "SELECT terminal_id FROM terminals WHERE station_id = '5'";
...
$i=1;
$Query_Check_Avail = "SELECT availability_id FROM terminals WHERE station_id = '5'";
...
$Query_Check_Bike = "SELECT serial_nb,terminal_id FROM bikes WHERE terminal_id = '41' OR terminal_id = '42' OR terminal_id = '43' OR terminal_id = '44' OR terminal_id = '45' OR terminal_id = '46' OR terminal_id = '47' OR terminal_id = '48' OR terminal_id = '49' OR terminal_id = '50'";//STATE NULL
