...
$i=1;
$Query_Check_terminalID = "SELECT terminal_id FROM terminals WHERE station_id = '6'";
...
$i=1;
$Query_Check_Avail = "SELECT availability_id FROM terminals WHERE station_id = '6'";
...
$Query_Check_Bike = "SELECT serial_nb,terminal_id FROM bikes WHERE terminal_id = '51' OR terminal_id = '52' OR terminal_id = '53' OR terminal_id = '54' OR terminal_id = '55' OR terminal_id = '56' OR terminal_id = '57' OR terminal_id = '58' OR terminal_id = '59' OR terminal_id = '60'";//STATE NULL
