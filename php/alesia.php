...
$i=1;
$Query_Check_terminalID = "SELECT terminal_id FROM terminals WHERE station_id = '1'";
...
$i=1;
$Query_Check_Avail = "SELECT availability_id FROM terminals WHERE station_id = '1'";
...
$Query_Check_Bike = "SELECT serial_nb,terminal_id FROM bikes WHERE terminal_id = '1' OR terminal_id = '2' OR terminal_id = '3' OR terminal_id = '4' OR terminal_id = '5' OR terminal_id = '6' OR terminal_id = '7' OR terminal_id = '8' OR terminal_id = '9' OR terminal_id = '10'";//STATE NULL
...
$myJSON = json_encode($object);//On encore l'objet en JSON afin de pouvoir le lire en JS
echo $myJSON;
