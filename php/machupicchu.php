...
$i=1;
$Query_Check_terminalID = "SELECT terminal_id FROM terminals WHERE station_id = '9'";
...
$i=1;
$Query_Check_Avail = "SELECT availability_id FROM terminals WHERE station_id = '9'";
...
$Query_Check_Bike = "SELECT serial_nb,terminal_id FROM bikes WHERE terminal_id = '81' OR terminal_id = '82' OR terminal_id = '83' OR terminal_id = '84' OR terminal_id = '85' OR terminal_id = '86' OR terminal_id = '87' OR terminal_id = '88' OR terminal_id = '89' OR terminal_id = '90'";//STATE NULL
